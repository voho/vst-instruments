...
echo "  ${BUILD_DIR}/Ghostar_artefacts/${CONFIG}/VST3/Ghostar.vst3"
echo "  ${BUILD_DIR}/Ghostar_artefacts/${CONFIG}/AU/Ghostar.component"
echo "  ${BUILD_DIR}/Ghostar_artefacts/${CONFIG}/Standalone/Ghostar.app"
