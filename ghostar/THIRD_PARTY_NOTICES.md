...
Ghostar's original source code is covered by the `LICENSE` file included with
each source or binary distribution. Ghostar builds against one separately
...
Ghostar's engine is an independent implementation informed by published
...
- The modelled instrument's factory owner's manual and service-manual
  ...
  reproduced in this repository. Ghostar is not affiliated with, endorsed by,
...
Building or distributing Ghostar with JUCE therefore requires either compliance
