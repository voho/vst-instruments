...
- 2026-08-16: Added direct regression coverage for `mix()` and `smoothStep()`'s non-finite-input sanitizing, matching the guard already proved for `meterPositionForLinear` and `MeterBallistics::update`.
