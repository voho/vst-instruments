...
echo "  ${BUILD_DIR}/Ghost_artefacts/${CONFIG}/VST3/Ghost.vst3"
echo "  ${BUILD_DIR}/Ghost_artefacts/${CONFIG}/AU/Ghost.component"
echo "  ${BUILD_DIR}/Ghost_artefacts/${CONFIG}/Standalone/Ghost.app"
