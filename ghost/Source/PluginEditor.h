...
// knobs, rockers, sliders or wheels — with Ghost's own livery: near-black
// panel, bone silkscreen, spectral cyan pointers.
class GhostLookAndFeel final : public juce::LookAndFeel_V4
{
public:
    GhostLookAndFeel();
...
public:
    ...
    ~GhostAudioProcessorEditor() override;
