...
// Ghost's livery: near-black panel, bone silkscreen, spectral cyan pointers.
...
GhostLookAndFeel::GhostLookAndFeel()
{
...
void GhostLookAndFeel::drawRotarySlider(juce::Graphics& g, int x, int y,
...
void GhostLookAndFeel::drawLinearSlider(juce::Graphics& g, int x, int y,
...
void GhostLookAndFeel::drawToggleButton(juce::Graphics& g,
      ...
      keyboard(p.keyboardState, juce::MidiKeyboardComponent::horizontalKeyboard)
{
    ...
    wordmark.setText("ghost", juce::dontSendNotification);
...
GhostAudioProcessorEditor::~GhostAudioProcessorEditor()
{
    setLookAndFeel(nullptr);
}

void GhostAudioProcessorEditor::addKnob(Knob& knob, const char* parameterId,
...
void GhostAudioProcessorEditor::addFader(Fader& fader, const char* parameterId,
                                         const juce::String& text)
{
...
void GhostAudioProcessorEditor::addRocker(Rocker& rocker,
...
void GhostAudioProcessorEditor::addSelector(Selector& selector,
                                            const char* parameterId,
                                            const juce::String& text)
{
...
void GhostAudioProcessorEditor::layoutKnob(Knob& knob,
...
void GhostAudioProcessorEditor::layoutFader(Fader& fader,
                                            juce::Rectangle<int> area)
{
...
void GhostAudioProcessorEditor::layoutSelector(Selector& selector,
                                               juce::Rectangle<int> area)
{
