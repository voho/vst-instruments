...
GhostAudioProcessor::GhostAudioProcessor()
    : AudioProcessor(BusesProperties().withOutput(
      ...
      parameters(*this, nullptr, "GhostParameters", createParameterLayout())
{
...
GhostAudioProcessor::createParameterLayout()
{
    const ghost::EngineParameters defaults {};
...
bool GhostAudioProcessor::isBusesLayoutSupported(
...
void GhostAudioProcessor::updateEngineParameters() noexcept
{
    ghost::EngineParameters engineParameters;
    engineParameters.tune = loadTravel(parameters, ids::tune);
    engineParameters.octave =
        static_cast<ghost::MasterOctave>(loadIndex(parameters, ids::octave));
    engineParameters.oscAWaveform =
        static_cast<ghost::Waveform>(loadIndex(parameters, ids::oscAWaveform));
    engineParameters.sync = loadRocker(parameters, ids::sync);
    engineParameters.oscBWaveform =
        static_cast<ghost::Waveform>(loadIndex(parameters, ids::oscBWaveform));
    engineParameters.oscBRange =
        static_cast<ghost::OscBRange>(loadIndex(parameters, ids::oscBRange));
    engineParameters.interval = loadTravel(parameters, ids::interval);
    engineParameters.trigger =
        static_cast<ghost::TriggerMode>(loadIndex(parameters, ids::trigger));
    ...
    engineParameters.arpeggiator = static_cast<ghost::ArpeggiatorMode>(
        loadIndex(parameters, ids::arpeggiator));
    engineParameters.modSource =
        static_cast<ghost::ModSource>(loadIndex(parameters, ids::modSource));
    engineParameters.lfoRate = loadTravel(parameters, ids::lfoRate);
    engineParameters.shaperMode =
        static_cast<ghost::ShaperMode>(loadIndex(parameters, ids::shaperMode));
    ...
    engineParameters.modXTo =
        static_cast<ghost::ModXDestination>(loadIndex(parameters, ids::modXTo));
    engineParameters.shapeXWithY = loadRocker(parameters, ids::shapeXWithY);
    engineParameters.shaperYTo = static_cast<ghost::ShaperYDestination>(
    ...
    engineParameters.upperResonance = static_cast<ghost::UpperResonanceMode>(
    ...
    engineParameters.slope =
        static_cast<ghost::UpperSlope>(loadIndex(parameters, ids::slope));
    engineParameters.kbAmount = loadTravel(parameters, ids::kbAmount);
    engineParameters.lowerMode = static_cast<ghost::LowerFilterMode>(
        loadIndex(parameters, ids::lowerMode));
    engineParameters.tracking =
        static_cast<ghost::TrackingMode>(loadIndex(parameters, ids::tracking));
...
void GhostAudioProcessor::handleMidiMessage(
...
void GhostAudioProcessor::handleNoteOn(juce::MidiKeyboardState*, int,
                                       int midiNoteNumber, float velocity)
{
    enqueueUiMidiEvent(midiNoteNumber, velocity, true);
}

void GhostAudioProcessor::handleNoteOff(juce::MidiKeyboardState*, int,
                                        int midiNoteNumber, float)
{
    enqueueUiMidiEvent(midiNoteNumber, 0.0f, false);
}

void GhostAudioProcessor::enqueueUiMidiEvent(int note, float velocity,
...
void GhostAudioProcessor::dispatchUiMidiEvents() noexcept
{
...
void GhostAudioProcessor::getStateInformation(
