...
cmake_args=(
    ...
    "-DYOUKNOW201_BUILD_UNIVERSAL=${BUILD_UNIVERSAL}"
    -DYOUKNOW201_BUILD_PLUGIN=ON
    -DBUILD_TESTING=ON
)
...
if [[ -n "${JUCE_PATH:-}" ]]; then
    cmake_args+=("-DYOUKNOW201_JUCE_PATH=${JUCE_PATH}")
fi
...
echo "  ${BUILD_DIR}/YouKnow201_artefacts/${CONFIG}/VST3/YouKnow201.vst3"
echo "  ${BUILD_DIR}/YouKnow201_artefacts/${CONFIG}/AU/YouKnow201.component"
echo "  ${BUILD_DIR}/YouKnow201_artefacts/${CONFIG}/Standalone/YouKnow201.app"
