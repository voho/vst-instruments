...
snapshots put 4× / 1× at **0.515 / 0.145×
realtime idle**, **0.480 / 0.151×** for six plain voices, **0.635 / 0.183×**
for the high-resonance fixture and **0.751 / 0.283×** for the full-mixer
...
full-waveform errors are −24.35/−25.81 and −27.05/−28.18 dB RMS for
44.1/48 kHz. The independent-reference method and complete matrix are in the
comparative assessment. The production DCO reconstruction and its reported
latency changed; its timer, ramp, comparator, sub and scan laws did not. The
global rate selector remains unchanged, and no domain split is admitted.
...
0.542977 (−5.30 dB) common gain so their relative levels survive 16-bit
