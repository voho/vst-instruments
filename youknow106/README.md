...
| OQ-03 | Chorus noise and SNR under calibrated conditions. Mode I's per-line floor is the MN3009's own 0.2 mVrms max A-weighted row referred through the model's measured 0.4026 transfer; mode II ships the reported ~3.95 dB delta as a relative factor. Absolute noise PSD is open | P0 |
