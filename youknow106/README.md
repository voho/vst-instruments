...
the experimental `Fast (Hermite 512)` kernel. Exact is the default for new and
historical sessions; neither setting belongs to a patch, Program Change, SysEx
dump or randomization. The approximation research, measured CPU results and
blind-audition protocol are recorded in
