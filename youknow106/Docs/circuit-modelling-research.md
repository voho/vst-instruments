...
| Calibrated chorus noise and SNR | OQ-03 — *the rate-proportional candidate for the measured 3.95 dB II−I delta now ships behind its own off-by-default switch, so the hypothesis is testable without being asserted* |
