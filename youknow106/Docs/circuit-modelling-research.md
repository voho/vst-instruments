...
| Chorus modulation | Measured 1.66–5.35 ms in **both** modes, with only the rate differing: 0.513 Hz and 0.863 Hz | The same centre and sweep for both modes | **Anchored.** Mode II is faster, not deeper, which is why it reads as more agitated rather than wider |
