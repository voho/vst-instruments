...
| Voice summer and high-pass | IC1a receives every voice through 33 kΩ against 3.3 kΩ feedback. Its summed output crosses C14 10 µF NP and R39 33 kΩ directly into TC4052BP YCOM on the jack board; Tr3 drives INH and is not an audio buffer. Selected Cut Y0/Y1 legs include R23/R21 1 MΩ | The six voices sum at `3.3/33 = 0.1` each. The current approximation gives C14 one state: Boost/Flat add R25/R27 47 kΩ in parallel with R39 for 0.820915 Hz; it treats the selected Cut branch as open for this C14 calculation, leaving R39 and 0.482288 Hz. The separate switch model then applies the derived Boost shelf (+10.50 dB DC, +1.41 dB high band, 59.41 Hz pole), Flat pass, or 225.8/720.5 Hz cut pole. Deselected C10/C11 Cut states have derived 15.705/4.9209 ms decays but are not yet represented as independent switching memory | **Anchored/derived** placement, populated parts, control routing, Boost/Flat legs, Cut corners and deselected decay constants. The 0.482288 Hz selected-Cut C14 result is explicitly a current approximation, not an anchored hardware asymptote: the physical selected leg includes its 1 MΩ path and is coupled to C14. Full switched-network MNA, CMOS parasitics and mode-change memory remain OQ-21. Unity-summing the voices overdrives every downstream common stage by 20 dB |
