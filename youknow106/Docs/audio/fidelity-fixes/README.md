...
| --- | ---: | ---: |
| `01-unison-tuning` | -44.4 | -47.6 |
| `02-output-summer-drive` | -28.9 | -34.7 |
| `03-chorus-wet` | -41.5 | -47.3 |
| `04-resonant-sweep` | -67.4 | -76.2 |
| `05-saw-bass` | -63.8 | -69.6 |
| `06-unit-character-sweep` | -25.8 | -41.4 |
| `07-high-lead` | -57.2 | -62.1 |
