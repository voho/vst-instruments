...
Every other file here renders at the shipped 70% Unit Character, which is what
...
| `06-chorus-modes.wav` | The same pad with the effect off, in mode I, then in mode II | 15.8 s | −11.7 dBFS | +8.7 dB |
| `07-unison-glide.wav` | Six-voice unison lead with constant-rate portamento | 11.5 s | −7.8 dBFS | +4.8 dB |
