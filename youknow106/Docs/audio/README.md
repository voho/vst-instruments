...
regenerated after the Step-7 DCO reconstruction/95-tap output boundary and the
Step-8 causal BBD input-edge reconstruction, so their samples and the peak
table below describe the current engine.
...
| --- | --- | ---: | ---: | ---: |
| `01-chorus-pad.wav` | Saw and sub through the mode-I chorus: the classic pad, hiss and all | 21.9 s | −4.2 dBFS | +1.2 dB |
