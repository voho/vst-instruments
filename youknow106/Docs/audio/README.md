...
regenerated after the Step-7 DCO reconstruction and 95-tap output-boundary
change, so their samples and the peak table below describe the current engine.
