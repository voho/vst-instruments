...
int main(int argc, char** argv)
{
    ...
    if ((!retriggerScenario && !commonVcaScenario)
    ...
    const bool written = retriggerScenario
        ? (stage == "before" ? writeBefore(outputDirectory, rendered, error)
                             : writeAfter(outputDirectory, rendered, error))
        : (stage == "before" ? writeCommonVcaBefore(outputDirectory, rendered, error)
