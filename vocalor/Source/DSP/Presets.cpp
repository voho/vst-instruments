...
// reach -- it wanted 2.23 against a published maximum of 2.0 -- so it takes
// 1.951 of that 2.0 and the last 1.2 dB from its own Dynamics, which moves
// from 0.30 to 0.34.
constexpr std::array<FactoryPreset, 12> presets { {
    ...
    { "Pressed Tenor", {
        ...
        .spread = 0.22f, .tension = 0.88f, .room = 0.18f, .outputGain = 0.589f,
    ...
    { "Legato Soloist", {
        ...
        .spread = 0.24f, .tension = 0.48f, .room = 0.26f, .outputGain = 1.330f,
    ...
    { "Breath And Air", {
        ...
        .spread = 0.40f, .tension = 0.08f, .room = 0.46f, .outputGain = 1.951f,
    ...
    { "Warm Bass Choir", {
        ...
        .spread = 0.78f, .tension = 0.24f, .room = 0.32f, .outputGain = 0.459f,
    ...
    { "Closed Mouth Hum", {
        ...
        .spread = 0.66f, .tension = 0.22f, .room = 0.34f, .outputGain = 1.030f,
    ...
    { "Small Voices", {
        ...
        .spread = 0.74f, .tension = 0.30f, .room = 0.30f, .outputGain = 0.586f,
    ...
    { "Vowel Morph Pad", {
        ...
        .spread = 0.84f, .tension = 0.34f, .room = 0.48f, .outputGain = 0.490f,
    ...
    { "Locked Major Chorale", {
        ...
        .spread = 0.70f, .tension = 0.45f, .room = 0.40f, .outputGain = 0.524f,
    ...
    { "Airy Minor Pad", {
        ...
        .spread = 0.88f, .tension = 0.12f, .room = 0.52f, .outputGain = 1.224f,
