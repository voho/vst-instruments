...
// tract weights both changes differently in every program, so the four that
// moved beyond the bank's 1 dB tolerance are re-trimmed below. This restores
// the same voiced chord without undoing either physical spectrum change.
constexpr std::array<FactoryPreset, 12> presets { {
    ...
    { "Pressed Tenor", {
        ...
        .spread = 0.22f, .tension = 0.88f, .room = 0.18f, .outputGain = 0.503f,
    ...
    { "Legato Soloist", {
        ...
        .spread = 0.24f, .tension = 0.48f, .room = 0.26f, .outputGain = 1.177f,
    ...
    { "Warm Bass Choir", {
        ...
        .spread = 0.78f, .tension = 0.24f, .room = 0.32f, .outputGain = 0.610f,
    ...
    { "Small Voices", {
        ...
        .spread = 0.74f, .tension = 0.30f, .room = 0.30f, .outputGain = 0.580f,
    ...
    { "Vowel Morph Pad", {
        ...
        .spread = 0.84f, .tension = 0.34f, .room = 0.48f, .outputGain = 0.303f,
    ...
    { "Locked Major Chorale", {
        ...
        .spread = 0.70f, .tension = 0.45f, .room = 0.40f, .outputGain = 0.439f,
