...
ARTIFACT_DIR="${BUILD_DIR}/Vocalor_artefacts/${CONFIG}"
...
VST3="${ARTIFACT_DIR}/VST3/Vocalor.vst3"
AU="${ARTIFACT_DIR}/AU/Vocalor.component"
APP="${ARTIFACT_DIR}/Standalone/Vocalor.app"
...
ditto "${VST3}" "${PACKAGE_ROOT}/Library/Audio/Plug-Ins/VST3/Vocalor.vst3"
ditto "${AU}" "${PACKAGE_ROOT}/Library/Audio/Plug-Ins/Components/Vocalor.component"
ditto "${APP}" "${PACKAGE_ROOT}/Applications/Vocalor.app"
...
sign_bundle "${PACKAGE_ROOT}/Library/Audio/Plug-Ins/VST3/Vocalor.vst3"
sign_bundle "${PACKAGE_ROOT}/Library/Audio/Plug-Ins/Components/Vocalor.component"
sign_bundle "${PACKAGE_ROOT}/Applications/Vocalor.app"

ZIP_PATH="${DIST_DIR}/Vocalor-${VERSION}-macOS-universal.zip"
PKG_UNSIGNED="${DIST_DIR}/Vocalor-${VERSION}-unsigned.pkg"
PKG_FINAL="${DIST_DIR}/Vocalor-${VERSION}-macOS-universal.pkg"
...
pkgbuild \
    --root "${PACKAGE_ROOT}" \
    --identifier audio.vocalor.synth.pkg \
    --version "${VERSION}" \
    --install-location / \
    "${PKG_UNSIGNED}"
