...
| --- | --- | ---: | ---: | ---: |
| `01-solo-legato-phrase.wav` | A solo soprano phrase sung legato, with a light glide between notes | 10.5 s | −16.1 dBFS | +13.1 dB |
| `02-vowel-anchors.wav` | The three preset vowels on the female voice, then on the male | 11.3 s | −19.0 dBFS | +16.0 dB |
| `03-vowel-space-morph.wav` | One held note while the morph target walks every cardinal vowel | 13.2 s | −18.3 dBFS | +15.3 dB |
| `04-formant-shift.wav` | The whole tract shifted an octave up and down at a fixed pitch | 12.2 s | −15.6 dBFS | +12.6 dB |
| `05-ensemble-pad.wav` | Twelve independently humanised singers holding a chord pad | 11.6 s | −14.7 dBFS | +11.7 dB |
| `06-chord-mode-harmony.wav` | Single keys each rendered as a six-singer chord, major and minor | 12.7 s | −17.3 dBFS | +14.3 dB |
| `07-choir-dynamics.wav` | An eight-singer choir phrase sung from pianissimo to forte | 10.4 s | −12.0 dBFS | +9.0 dB |
| `08-tension-and-breath.wav` | A held male note from a lax to a pressed glottis, then into breath | 12.4 s | −18.6 dBFS | +15.6 dB |
| `09-room-small-and-large.wav` | The same motif sung in a dry booth and in a large hall | 11.5 s | −15.3 dBFS | +12.3 dB |
<!-- peaks-table-end -->
