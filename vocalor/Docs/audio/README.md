...
| --- | --- | ---: | ---: | ---: |
| `01-solo-legato-phrase.wav` | A solo soprano phrase sung legato, with a light glide between notes | 10.5 s | −18.0 dBFS | +15.0 dB |
| `02-vowel-anchors.wav` | The three preset vowels on the female voice, then on the male | 11.3 s | −15.4 dBFS | +12.4 dB |
| `03-vowel-space-morph.wav` | One held note while the morph target walks every cardinal vowel | 13.2 s | −19.1 dBFS | +16.1 dB |
| `04-formant-shift.wav` | The whole tract shifted an octave up and down at a fixed pitch | 12.2 s | −15.1 dBFS | +12.1 dB |
| `05-ensemble-pad.wav` | Twelve independently humanised singers holding a chord pad | 11.6 s | −14.1 dBFS | +11.1 dB |
| `06-chord-mode-harmony.wav` | Single keys each rendered as a six-singer chord, major and minor | 15.1 s | −18.8 dBFS | +15.8 dB |
| `07-choir-dynamics.wav` | An eight-singer choir phrase sung from pianissimo to forte | 11.5 s | −13.3 dBFS | +10.3 dB |
| `08-tension-and-breath.wav` | A held male note from a lax to a pressed glottis, then into breath | 16.9 s | −18.9 dBFS | +15.9 dB |
| `09-room-small-and-large.wav` | The same motif sung in a dry booth and in a large hall | 11.5 s | −16.5 dBFS | +13.5 dB |
<!-- peaks-table-end -->
