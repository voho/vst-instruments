...
6.36 dB and the largest adjacent-note change from 7.37 to 4.36 dB while leaving
...
| --- | --- | ---: | ---: | ---: |
| `01-solo-legato-phrase.wav` | A solo soprano phrase sung legato, with a light glide between notes | 10.5 s | −20.3 dBFS | +17.3 dB |
| `02-vowel-anchors.wav` | The three preset vowels on a less-resonant neutral female and male voice | 11.3 s | −18.8 dBFS | +15.8 dB |
| `03-vowel-space-morph.wav` | One held note while the morph target walks every cardinal vowel | 13.2 s | −19.3 dBFS | +16.3 dB |
| `04-formant-shift.wav` | The whole tract shifted an octave up and down at a fixed pitch | 12.2 s | −18.5 dBFS | +15.5 dB |
| `05-ensemble-pad.wav` | Twelve independently humanised singers holding a chord pad | 11.6 s | −9.8 dBFS | +6.8 dB |
| `06-chord-mode-harmony.wav` | Single keys each rendered as a six-singer chord, major and minor | 15.1 s | −19.6 dBFS | +16.6 dB |
| `07-choir-dynamics.wav` | An eight-singer choir phrase sung from pianissimo to forte | 11.5 s | −13.8 dBFS | +10.8 dB |
| `08-tension-and-breath.wav` | A held male note from a lax to a pressed glottis, then into breath | 16.9 s | −19.6 dBFS | +16.6 dB |
| `09-room-small-and-large.wav` | The same motif sung in a dry booth and in a large hall | 11.5 s | −18.9 dBFS | +15.9 dB |
| `10-soprano-register.wav` | A connected soprano line from C4 to C6 through the cluster release | 10.1 s | −18.8 dBFS | +15.8 dB |
<!-- peaks-table-end -->
