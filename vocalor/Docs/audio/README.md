...
| --- | --- | ---: | ---: | ---: |
| `01-solo-legato-phrase.wav` | A solo soprano phrase sung legato, with a light glide between notes | 10.5 s | −19.7 dBFS | +16.7 dB |
| `02-vowel-anchors.wav` | The three preset vowels on the female voice, then on the male | 11.3 s | −15.7 dBFS | +12.7 dB |
| `03-vowel-space-morph.wav` | One held note while the morph target walks every cardinal vowel | 13.2 s | −20.1 dBFS | +17.1 dB |
| `04-formant-shift.wav` | The whole tract shifted an octave up and down at a fixed pitch | 12.2 s | −15.7 dBFS | +12.7 dB |
| `05-ensemble-pad.wav` | Twelve independently humanised singers holding a chord pad | 11.6 s | −14.2 dBFS | +11.2 dB |
| `06-chord-mode-harmony.wav` | Single keys each rendered as a six-singer chord, major and minor | 15.1 s | −20.1 dBFS | +17.1 dB |
| `07-choir-dynamics.wav` | An eight-singer choir phrase sung from pianissimo to forte | 11.5 s | −14.4 dBFS | +11.4 dB |
| `08-tension-and-breath.wav` | A held male note from a lax to a pressed glottis, then into breath | 16.9 s | −20.0 dBFS | +17.0 dB |
| `09-room-small-and-large.wav` | The same motif sung in a dry booth and in a large hall | 11.5 s | −17.9 dBFS | +14.9 dB |
<!-- peaks-table-end -->
