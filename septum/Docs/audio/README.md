...
| --- | --- | ---: | ---: | ---: |
| `01-supersaw-lead.wav` | Both oscillators SUPER SAW: a trance line into a held stack | 8.5 s | −9.1 dBFS | +6.1 dB |
...
| `07-pwm-strings.wav` | Pulse-width modulation strings through the chorus delay template | 15.8 s | −1.8 dBFS | −1.2 dB |
