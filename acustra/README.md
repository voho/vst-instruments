...
| `02-nylon-fingerstyle.wav` | A fingertip nylon arpeggio with overlapping held notes | 4.2 s | −19.3 dBFS | +16.3 dB |
| `03-shape-material-anchors.wav` | One chord: Parlor/Jumbo, then Cedar/Maple anchor settings | 13.7 s | −9.4 dBFS | +6.4 dB |
| `04-string-age.wav` | The same steel phrase with fresh strings, then fully aged strings | 6.5 s | −7.7 dBFS | +4.7 dB |
| `05-alternate-tunings.wav` | Drop D, DADGAD and Open G chords | 12.3 s | −10.8 dBFS | +7.8 dB |
| `06-playing-behaviours.wav` | A chord change over a ringing chord, CC2 bridge-hand damping, then two natural harmonics above the fretted range | 10.7 s | −12.0 dBFS | +9.0 dB |
...
- The two-way junction and the stub anchor are calibrated around a
  ...
  against the recordings' 6, and the benchmark reads 6.319236, 6.327235 and
  7.948337 against the previous engine's 6.835, 6.824 and 5.655, better on
