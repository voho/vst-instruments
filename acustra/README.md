...
| --- | --- | ---: | ---: | ---: |
| `01-steel-sustain-range.wav` | Steel sustain from open E2 to B5, one held pluck at a time | 9.5 s | −13.6 dBFS | +10.6 dB |
| `02-nylon-fingerstyle.wav` | A fingertip nylon arpeggio with overlapping held notes | 4.2 s | −18.7 dBFS | +15.7 dB |
| `03-shape-material-anchors.wav` | One chord: Parlor/Jumbo, then Cedar/Maple anchor settings | 13.7 s | −7.0 dBFS | +4.0 dB |
...
| `06-playing-behaviours.wav` | A chord change over a ringing chord, CC2 bridge-hand damping, then two natural harmonics above the fretted range | 10.7 s | −9.6 dBFS | +6.6 dB |
<!-- peaks-table-end -->
...
-22.8%, -16.9%, and -39.7%, respectively. These are engineering descriptors,
