...
//
//   YouKnowRenderTanhAuditions [--quality 1|2|4] [--early-cubic]
//                                [output-directory]
//
...
namespace realism = youknow::tools::realism;
...
int main(int argc, char** argv)
{
        ...
        ++fixtureIndex)
    {
        ...
        const Preset* preset = youknow::presets::findByNumber(fixture.presetNumber);
        if (preset == nullptr)
        {
