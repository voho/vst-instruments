...
inline constexpr std::array<PublicParameter, 48> publicParameterOrder {{
    ...
    PublicParameter { "hq", "HQ", false },
    PublicParameter { "quality", "Quality", false },
    PublicParameter { "vcfTanhMode", "VCF Tanh", false },
    PublicParameter { "vcfFastEarlyMode", "VCF Fast Early", false },
    PublicParameter { "vcfSolverMode", "VCF Solver", false },
