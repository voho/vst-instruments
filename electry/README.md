...
then follows fretting vibrato and a held Drop-E chord whose low string slides
exactly on the repeat grid. The played entrance becomes the wrist's first
contact, so its next pick is one complete interval later; the slide remains a
