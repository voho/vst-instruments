...
enum class VoiceProfile { Saturn, Phobos };
enum class PerformanceMode { Single, Stack, Fifth };
enum class FilterType { Ladder, Svf, Poles };
enum class FifthQuality { Free, Locked };

struct EngineParameters
{
    VoiceProfile profile { VoiceProfile::Saturn };
    PerformanceMode mode { PerformanceMode::Single };
    FilterType vowel { FilterType::Ladder };
    FifthQuality chordQuality { FifthQuality::Free };
    int choirSize { 8 };
    float breath { 0.28f };
